...
**NEW!** An updated version of the pre compiled files for the Leap Motion Library is now available at this [repository](https://github.com/Cipulot/Leap-Motion-Python-3), providing Python 3.8.6 support.
